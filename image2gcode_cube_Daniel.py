...
'''
def image2gcode_spiral_cube(image_list, toggle_ON_list, toggle_OFF_list, visualize_ON):
    black = 0
    white = 255
    img_list = []
    ...
    for layer in range(num_layers):
        ...
        for coordinates in range(len(p_list)):
            if p_list[coordinates] not in outer_edge_list:
                ...
                for pixel in current_img:
                    ...
                    if prev_pixel != pixel:
                        if pixel == black:
                            ...
                            print(valve_on)
                            allowed_dist -= current_distance
                        elif pixel != black and layer > 0:
                            if visualize_ON == True:
                                print('G0 ' + str(variable) + str(sign) + str(current_distance))
                            else:
                                print('G1 ' + str(variable) + str(sign) + str(current_distance))
                ...
                print('G1 ' + str(variable) + str(sign) + str(allowed_dist))
...
if __name__ == '__main__':
    image1 = 'temp_aaron.png'#'temp_heart.png'
    image2 = 'temp_smiley.png'
    image3 = 'temp_heart.png'
    image4 = 'temp_sarah_waz.png'
    ...
    image2gcode_spiral_cube(image_list, toggle_ON_list, toggle_OFF_list, visualize_ON)
